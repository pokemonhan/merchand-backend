        ...
        <div>
            ...
            <ul v-if="curr_set_btn===1" class="form">
                <li>
                    ...
                    <div class="li-right">
                        <span>注册邀请邀请码:</span>
                        <Switchbox v-model="login_set.aa" />
                    </div>
                </li>
            </ul>
            <!-- 游戏设定 -->
            ...
            <ul v-if="curr_set_btn===3" class="form">
                <li>
                    ...
                    <div class="li-right">
                        ...
                        <Switchbox v-model="active_limit_set.aa" />
                    </div>
                </li>
                <li>
                    <div class="li-left">
            ...
            <ul v-if="curr_set_btn===4" class="form">
                ...
                <li>
                    <div class="li-left">
                        <span>稽核不足限制出款:</span>
                        <Checkbox v-model="payment_form.aaa" />
                    </div>
                    <div class="li-right">
